    ...
    for r in range ( len(nmp) ):
        for c in range ( len(nmp[r]) ):
            ...
            if (row2 <= nmp[r][c] and entry == 0    ):     
                ...
                entry == 1  
            elif ( entry == 0 and row2 != nmp[2][3]): # если в самом конце последний элемент масива не подходит и до этогоо небыло вхождений , следовательно список закончен и поисковый запрос не содерэит оценки фильма
                df['classs'] = "undefined" 
